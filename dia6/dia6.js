let frutas = ["pera","banana","laranja","pitaya","uva"];
let laticinios = ["queijo","iogurte","leite"];
let legumes = ["tomate","cebola","batata","cenoura","batata baroa"];
let doces = ["doce de leite","Goiabada","bala","chiclete"];
...
while(opcaoAdicionar == "sim"){
    ...
    opcaoAdicionar = prompt("Você deseja adicionar uma comida na sua lista de compras? sim\não");
